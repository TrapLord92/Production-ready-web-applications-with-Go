...
import (
	...
	"github.com/TrapLord92/Production-ready-web-applications-with-Go/internal/validator"
...
func (app *application) snippetCreate(w http.ResponseWriter, r *http.Request) {
	...
	// Notice how this is also a great opportunity to set any default or// 'initial' values for the form --- here we set the initial value for the
